...
SOURCE_FILES = [
    ...
    'kin_polar.c', 'kin_polar_corerz.c', 'kin_rotary_delta.c', 'kin_winch.c',
...
defs_kin_polar_corerz = """
    struct stepper_kinematics *polar_corerz_stepper_alloc(char type);
"""
...
defs_all = [
    ...
    defs_kin_polar, defs_kin_polar_corerz, defs_kin_rotary_delta,
